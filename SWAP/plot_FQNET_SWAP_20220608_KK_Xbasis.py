...
START_TIME = '2022-06-07 17:16:57'
END_TIME = '2022-06-07 22:16:57'
...
try:
	...
	for i in range(len(time_tab2_el)):
		bin = bin+Ch16[i]
		#print(adqtime/10)
		if j < 15 and i%round(30*60/adqtime_tab2)==0:
	...
	plt.plot(x_basis_signal,label='signal')
	plt.plot(x_basis_noise,label='noise')
