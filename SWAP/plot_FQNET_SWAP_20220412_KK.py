...
START_TIME = '2022-04-12 23:03:00'
END_TIME = '2022-04-13	08:00:00'
...
try:
	...
	with db_gui.cursor(pymysql.cursors.DictCursor) as cur:
		TABLE_NAME = "TAB112_04_2022_22_52_49"
		...
		TABLE_NAME = "TAB212_04_2022_22_52_49"
	...
	tab1_titles = ["ee noise", "ll noise", "el signal", "le signal"]#, ["Rb1", "Rb2", "Rb3"], ["Rc1","Rc2", "Rc3"]]
	...
	fidelity = total_signal/(total_signal+total_noise)

	print("ee total counts: ",ee_counts)
	print("ll total counts: ",ll_counts)
	print("el total counts: ",el_counts)
	print("le total counts: ",le_counts)


	print("ee noise counts: ",ee_noise)
	print("ll noise counts: ",ll_noise)
	print("el signal counts: ",el_signal)
	print("le signal counts: ",le_signal)
