...
START_TIME = '2022-06-04 17:33:00'
END_TIME = '2022-06-04 23:24:00'
table_start_time = "04_06_2022_17_10_31"
tab1_table_name = "TAB1"+"04_06_2022_17_10_30"
...
try:
	...
	tab2_titles = ["total el le", "total ee ll", "BSM"]#, ["Rb1", "Rb2", "Rb3"], ["Rc1","Rc2", "Rc3"]]
	...
	fidelity = 0#signal/(signal+noise)
	error_n = 0#np.sqrt(noise)*signal/((signal+noise)**2)
	error_s = 0#np.sqrt(signal)*noise/((signal+noise)**2)
	total_error = 0#np.sqrt(error_n**2+error_s**2)
