...
START_TIME = '2022-05-11 14:32:00'
END_TIME = '2022-05-11 14:36:00'
...
try:
	...
	branch_1_eff = alice_signal/(sum(A0)+sum(A1))
	alice_eff = alice_signal/(sum(D0)+sum(D1))

	print("Beam Splitter Eff: ",branch_1_eff)
	print("Alice Efficiency: ",alice_eff)
