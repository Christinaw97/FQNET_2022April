...
START_TIME = '2022-04-04 16:12:30'
...
try:
 ...
 #Rb1 = Rb1[histo_indices[0]:histo_indices[-1]]
	...
	for i in range(2):
		...
		tab2_data[i][tab2_indices[0]:tab2_indices[-1]]/normRA1Array[tab2_indices[0]:tab2_indices[-1]],
		 linestyle = 'none', marker = '.', markersize = 8)
