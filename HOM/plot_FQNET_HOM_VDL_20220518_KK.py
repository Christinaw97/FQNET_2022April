...
START_TIME = '2022-05-18 17:38:00'
END_TIME = '2022-05-18	18:53:00'
...
try:
 ...
 #Rb1 = Rb1[histo_indices[0]:histo_indices[-1]]
	...
	hom_counts_norm_a = tab2_data[0][tab2_indices[0]:tab2_indices[-1]]/normA0Array[tab2_indices[0]:tab2_indices[-1]]
	hom_counts_norm_b = tab2_data[1][tab2_indices[0]:tab2_indices[-1]]/normB0Array[tab2_indices[0]:tab2_indices[-1]]
	...
	HOM_df.to_csv('HOM_VDL_20220518_3fb_norm_b.csv',index=False)
