...
import time
import pandas as pd
delay_step_time = 1800
adqtime_tab2=1
adqtime_histo=1


START_TIME = '2022-04-04 16:14:45'
END_TIME = '2022-04-05 00:14:45'
...
try:
 ...
 #Rb1 = Rb1[histo_indices[0]:histo_indices[-1]]
	...
	fig1.savefig(cur_file_name+'counts.png')
	fig1.savefig(cur_file_name+'counts.pdf')
	...
	fig2.savefig(cur_file_name+'hom_NoNormalization_fit.png')
	fig2.savefig(cur_file_name+'hom_NoNormalization_fit.pdf')
	...
	for i in range(2):
		...
		tab2_data[i][tab2_indices[0]:tab2_indices[-1]]/normRB1Array[tab2_indices[0]:tab2_indices[-1]],
		 linestyle = 'none', marker = '.', markersize = 8)
	...
	fig3.savefig(cur_file_name+'hom_Normalized_fit.png')
	fig3.savefig(cur_file_name+'hom_Normalized_fit.pdf')
