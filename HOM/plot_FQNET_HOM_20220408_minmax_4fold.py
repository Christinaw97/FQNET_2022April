...
START_TIME_tab1 = '2022-04-08 21:35:40'
END_TIME_tab1 = '2022-04-09 02:20:40'
START_TIME_tab2 = '2022-04-08 21:35:40'
END_TIME_tab2 = '2022-04-08 23:35:40'
...
try:
	...
	with db_gui.cursor(pymysql.cursors.DictCursor) as cur:
		TABLE_NAME = "TAB108_04_2022_14_29_50"
		...
		TABLE_NAME = "TAB208_04_2022_14_29_50"
		queryGUI = "SELECT ch0, ch1, ch2, ch3, ch4, datetime FROM "+TABLE_NAME+" WHERE datetime BETWEEN {ts %s} AND {ts %s}"
	...
	ax = axs[0]
	ax.plot(time_tab2_el_mins, ch2)
	ax.set_ylabel("Twofolds")
	ax = axs[1]
	ax.plot(time_tab2_el_mins, ch3)
	ax.set_ylabel("Threefold (heralding on Bob 2)")
	ax = axs[2]
	ax.plot(time_tab2_el_mins, ch4)
	...
	two_fold_max = sum(ch2[:half])
	two_fold_min = sum(ch2[half:])
	three_fold_max = sum(ch3[:half])
	three_fold_min = sum(ch3[half:])
	four_fold_max = sum(ch4[:half])
	four_fold_min = sum(ch4[half:])

	two_fold_vis = 1 - two_fold_min/two_fold_max
	three_fold_vis = 1 - three_fold_min/three_fold_max
	...
	print("Three fold maximum counts :",three_fold_max)
	print("Three fold minimum counts :",three_fold_min)
	print("Three fold visilbility: ",three_fold_vis)
