...
import time
import pandas as pd
delay_step_times = np.array([60,60,60,90,90,90,90,90,90,90,90,90,60,60,60])*30##how many seconds per step(10 minutes is 600)
adqtime_tab2=2
adqtime_histo=2


START_TIME = '2022-05-13 21:18:00'
END_TIME = '2022-05-14	10:03:00'
...
try:
	...
	with db_gui.cursor(pymysql.cursors.DictCursor) as cur:
		TABLE_NAME = "TAB113_05_2022_15_53_33"
		...
		TABLE_NAME = "TAB213_05_2022_15_53_33"
 ...
 #Rb1 = Rb1[histo_indices[0]:histo_indices[-1]]
	...
	HOM_df.to_csv('HOM_20220514_2f_norm_b.csv',index=False)
