...
import pandas as pd
delay_step_time = 360
delay_step_times = delay_step_time*np.ones(5)##how many seconds per step(10 minutes is 600)
adqtime_tab2=2
adqtime_histo=2


START_TIME = '2022-08-01 15:29:56'
...
try:
	...
	with db_gui.cursor(pymysql.cursors.DictCursor) as cur:
		TABLE_NAME = "TAB129_07_2022_17_31_53"
		...
		TABLE_NAME = "TAB229_07_2022_17_31_53"
