...
adqtime_tab2=2
adqtime_histo=2
#START_TIME = '2022-05-17 18:28:00'
#END_TIME = '2022-05-17	19:43:00'


START_TIME = '2022-05-16 15:31:00'
END_TIME = '2022-05-16	16:46:00'
...
try:
	...
	with db_gui.cursor(pymysql.cursors.DictCursor) as cur:
		TABLE_NAME = "TAB116_05_2022_15_29_44"
		...
		TABLE_NAME = "TAB216_05_2022_15_29_44"
 ...
 #Rb1 = Rb1[histo_indices[0]:histo_indices[-1]]
	...
	tab1_titles = ["Charlie 1", "Bob", "Charlie 2", "Alice"]#, ["Rb1", "Rb2", "Rb3"], ["Rc1","Rc2", "Rc3"]]
	...
	hom_counts_norm_both = tab2_data[2][tab2_indices[0]:tab2_indices[-1]]/normA0Array[tab2_indices[0]:tab2_indices[-1]]/normB0Array[tab2_indices[0]:tab2_indices[-1]]

	hom_counts_norm_a = tab2_data[2][tab2_indices[0]:tab2_indices[-1]]/normA0Array[tab2_indices[0]:tab2_indices[-1]]
	hom_counts_norm_b = tab2_data[2][tab2_indices[0]:tab2_indices[-1]]/normB0Array[tab2_indices[0]:tab2_indices[-1]]


	print(hom_counts_no_norm)

	HOM_data = [[sum(steps[:i])*40,h] for i, h in enumerate(hom_counts_no_norm)]
	HOM_df = pd.DataFrame(HOM_data,columns=['delay_(ps)','counts_per_90_min'])
	#HOM_df.to_csv('HOM_20220516_2f.csv',index=False)
