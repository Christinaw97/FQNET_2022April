...
import time
import pandas as pd
delay_step_time = 90*60##how many seconds per step(10 minutes is 600)
adqtime_tab2=2
adqtime_histo=2


START_TIME = '2022-04-10 15:22:00'
END_TIME = '2022-04-11	01:00:00'
...
try:
	...
	with db_gui.cursor(pymysql.cursors.DictCursor) as cur:
		TABLE_NAME = "TAB110_04_2022_15_17_09"
		...
		TABLE_NAME = "TAB210_04_2022_15_17_09"
 ...
 #Rb1 = Rb1[histo_indices[0]:histo_indices[-1]]
	...
	HOM_data = [[t,hom_counts_no_norm[i]] for i, t in enumerate(times)]
	HOM_df = pd.DataFrame(HOM_data,columns=['delay_(ps)','counts_per_90_min'])
	HOM_df.to_csv('HOM_20220410_3f.csv',index=False)
