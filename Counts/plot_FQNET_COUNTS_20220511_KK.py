...
START_TIME = '2022-05-10 17:26:00'
END_TIME = '2022-05-11	02:45:00'
...
try:
	...
	with db_gui.cursor(pymysql.cursors.DictCursor) as cur:
		TABLE_NAME = "TAB110_05_2022_17_08_46"
	...
	tab1_titles = ["BS1", "Bob 2", "BS2", "Alice 1"]#, ["Rb1", "Rb2", "Rb3"], ["Rc1","Rc2", "Rc3"]]
	...
	tab2_data = [A1, B1, C1, D1]#, [Rb1, Rb2, Rb3], [Rc1, Rc2, Rc3]]
	tab2_titles = ["Plot A", "Plot B", "Plot C", "Plot D"]#, ["Rb1", "Rb2", "Rb3"], ["Rc1","Rc2", "Rc3"]]
