...
try:
	...
	with db_gui.cursor(pymysql.cursors.DictCursor) as cur:
		...
		END_TIME = time_JSI[-1]
		END_TIME = END_TIME + datetime.timedelta(seconds=delta_time.total_seconds()+3*100)




		TABLE_NAME = "TAB126_05_2022_15_27_31"
		...
		TABLE_NAME = "TAB226_05_2022_15_27_31"
 ...
 #Rb1 = Rb1[histo_indices[0]:histo_indices[-1]]
	...
	Alice_JSI = np.array(ch0_bin[0:81**2]).reshape(81,81)
	Bob_JSI = np.array(ch1_bin[0:81**2]).reshape(81,81)
